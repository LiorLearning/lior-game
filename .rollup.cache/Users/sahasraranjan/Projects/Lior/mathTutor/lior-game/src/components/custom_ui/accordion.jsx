...
const MyAccordionItem = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<AccordionPrimitive.Item ref={ref} className={cn("border-b", className)} {...props}/>);
});
MyAccordionItem.displayName = "AccordionItem";
const AccordionItem = withEventLogging(MyAccordionItem);
const MyAccordionTrigger = React.forwardRef((_a, ref) => {
...
const AccordionTrigger = withEventLogging(MyAccordionTrigger);
const MyAccordionContent = React.forwardRef((_a, ref) => {
    var { className, children } = _a, props = __rest(_a, ["className", "children"]);
...
MyAccordionContent.displayName = AccordionPrimitive.Content.displayName;
const AccordionContent = withEventLogging(MyAccordionContent);
