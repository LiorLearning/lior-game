...
const MySelectTrigger = React.forwardRef((_a, ref) => {
...
MySelectTrigger.displayName = SelectPrimitive.Trigger.displayName;
const SelectTrigger = withEventLogging(MySelectTrigger);
...
const MySelectItem = React.forwardRef((_a, ref) => {
    var { className, children } = _a, props = __rest(_a, ["className", "children"]);
...
MySelectItem.displayName = SelectPrimitive.Item.displayName;
const SelectItem = withEventLogging(MySelectItem);
