...
export const SandboxProvider = ({ children }) => {
    ...
    return (<SandboxContext.Provider value={{ componentRef, sendAdminMessage }}>
          ...
          <div className="w-[75%] border-r-border flex flex-col" ref={componentRef}>
            <div className="relative h-full w-full">
              ...
              <div className="relative h-full w-full flex flex-col">
                <div className="p-2">
                  <Button variant="outline" onClick={handleReloadPage} className="hover:bg-gray-100 text-foreground px-4 py-2 flex items-center gap-2" title="Reload Page">
                    <RefreshCw className="h-4 w-4"/>
                    <span>Reload</span>
                  </Button>
                </div>
                <div className="flex-1 flex justify-center items-center">
                  {isConnected ? (children) : (<div className="flex flex-col items-center justify-center h-full bg-gradient-to-b p-4">
