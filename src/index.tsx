...
export const SandboxProvider: React.FC<{ children: ReactNode }> = SandboxProviderComponent;
export const useSandboxContext: () => {
  componentRef: React.RefObject<HTMLDivElement> | null;
  sendAdminMessage?: (role: string, content: string) => Promise<void>;
} = useSandboxContextHook;

export const LiorGameProvider: React.FC<{ children: ReactNode, wsUrl?: string }> = LiorGameProviderComponent;
